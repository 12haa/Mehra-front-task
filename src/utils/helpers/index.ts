export const calculateTagPosition = (imageWidth, imageHeight, tagX, tagY, viewportWidth) => {
...
export const calculateModalPosition = (tagX, tagY, viewportWidth, viewportHeight) => {
