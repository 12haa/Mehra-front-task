    ...
    <div className="modal" ref={ref}>
      ...
      <div className="modal__nav-tags-main-div">
        ...
        <div className="modal__nav-right-tag">
          {[0, 1, 2].map((item, i) => (
            <img
              src="/src/assets/icons/RatingTags.svg"
      ...
      <div className="modal__nav-tags-image-div">
        <img
          src="/src/assets/icons/DummyProductImage.svg"
          alt="product image"
        />
      </div>
      ...
      <div className="modal__footer-main-div">
        ...
        <div className="modal__footer-right-tag-div">
          <p>(121)</p>
          <img
            src="/src/assets/icons/GrayRatingStar.svg"
            alt="rating Star"
            style={{
              width: "20px",
              height: "15.5px",
      ...
      <div className="modal__footer-end-div" dir="rtl">
        {/*<div className="modal__footer-end-right-div"></div>*/}
