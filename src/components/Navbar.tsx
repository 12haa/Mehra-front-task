...
const Navbar = () => {
    ...
    return (
        <nav className="navbar__wrapper">
            {menuOpen && <div className="navbar__menu-modal" ref={modalRef}>
                <Bounded as="div" style={{backgroundColor: "white"}} childrenStyle={{backgroundColor: "white"}}>
                    <div className="navbar_menu-items-main-div">
                        {NavMenuData.map((data, index) => (
                            <div className="navbar__menu-item" key={index}>
                                ...
                                {data.iconPath ? <img src={data.iconPath} alt="Menu Icon"/> : null}
                            </div>
                        ))}
                    </div>
                </Bounded>
